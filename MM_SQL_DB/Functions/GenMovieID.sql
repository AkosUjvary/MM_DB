...
CREATE OR ALTER FUNCTION control.f_genmovieid(@seq_num NUMERIC)
RETURNS VARCHAR(10)
AS
BEGIN
...
select control.f_genmovieid(NEXT VALUE FOR MOVIEDATA.SEQ_MOVIE_ID)
